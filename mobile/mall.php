...
switch($action) {
	case 'comment':
		...
		*/
		...
		$items = $r['num'];
		$pages = mobile_pages($items, $page, $pagesize, 'javascript:load_comment(\'{gaosou_page}&star='.$star.'\');');
	...
	case 'order':
		...
		*/
		...
		$items = $r['num'];
		$pages = mobile_pages($items, $page, $pagesize, 'javascript:load_order({gaosou_page});');
