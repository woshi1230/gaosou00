...
define("IN_KEKE",true);
	...
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('3','mreward','100','50',0,'1')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('4','mreward','100','50',0,'2')");
					}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('5','2','pub','发布任务','1','2','')");
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('8','2','work_hand','交稿','1','1','')");
					}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('25','5','1','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('26','5','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('27','5','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('28','5','4','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('29','5','5','')");

	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('55','8','1','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('56','8','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('57','8','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('58','8','4','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('59','8','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('224','5','6','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('228','8','6','')");
					}
