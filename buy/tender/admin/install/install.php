...
define("IN_KEKE",true);
	...
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('9','tender','100','50',0,'2')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('10','tender','100','50',0,'1')");
					}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('51','4','comment','留言','1','1','realname')");
					
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('49','4','pub','发布任务','1','2','')");
					}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('145','49','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('140','57','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('142','49','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('143','49','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('144','49','4','')");
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('127','49','1','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('129','51','1','1')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('294','51','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('295','51','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('296','51','4','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('297','51','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('298','51','6','')");
						}
