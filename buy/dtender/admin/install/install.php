...
define("IN_KEKE",true);
	...
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('7','dtender','100','50',0,'2')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('8','dtender','100','50','1','1')");
					}
	...
	$res = db_factory::execute("CREATE TABLE IF NOT EXISTS `".TB_PRE."witkey_model` (
		...
		if($col_info){
			if($col_info["Type"]!="varchar(50)"){
				db_factory::execute("alter  table ".TB_PRE."witkey_model  change column  model_intro model_intro varchar(50)");
			}
		}
		else{
			db_factory::execute("alter table ".TB_PRE."witkey_model add model_intro varchar(50) null default null ");
		}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('58','5','work_hand','交稿','1','1','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('59','5','pub','发布任务','1','2','')");
							}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('147','59','1','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('148','59','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('149','59','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('150','59','4','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('151','59','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('152','59','6','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('153','58','1','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('154','58','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('155','58','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('156','58','4','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('157','58','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('158','58','6','')");
				}
