...
class sreward_task_agreement extends yw_task_agreement {
...
//		$prom_obj = $objProm = keke_prom_class::get_instance ();;
		...
		$task_title = db_factory::get_count ( sprintf ( " select task_title from %switkey_task where task_id='%d'", TB_PRE, $this->_task_id ) );
