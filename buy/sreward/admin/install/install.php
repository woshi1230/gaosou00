...
define( "IN_KEKE" ,true);
	...
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('2','sreward','100','50',0,'2')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('1','sreward','100','50',0,'1')");
					}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('1','1','pub','发布任务','1','2','realname')");
	db_factory::execute("replace into ".TB_PRE."witkey_priv_item (`op_id`,`model_id`,`op_code`,`op_name`,`allow_times`,`limit_obj`,`condit`) values ('2','1','work_hand','交稿','1','1','')");
					}
	...
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('1','1','1','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('2','1','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('3','1','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('4','1','4','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('5','1','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('7','2','1','2')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('8','2','2','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('9','2','3','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('10','2','4','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('11','2','5','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('215','1','6','')");
					
	db_factory::execute("replace into ".TB_PRE."witkey_priv_rule (`r_id`,`item_id`,`mark_rule_id`,`rule`) values ('217','2','6','')");
					}
