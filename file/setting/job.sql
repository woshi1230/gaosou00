DROP TABLE IF EXISTS `gaosou_job`;
CREATE TABLE `gaosou_job` (
...
DROP TABLE IF EXISTS `gaosou_job_apply`;
CREATE TABLE `gaosou_job_apply` (
...
DROP TABLE IF EXISTS `gaosou_job_data`;
CREATE TABLE `gaosou_job_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='招聘内容';

DROP TABLE IF EXISTS `gaosou_job_talent`;
CREATE TABLE `gaosou_job_talent` (
...
DROP TABLE IF EXISTS `gaosou_resume`;
CREATE TABLE `gaosou_resume` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `catid` int(10) unsigned NOT NULL default '0',
  `areaid` int(10) unsigned NOT NULL default '0',
  `level` tinyint(1) unsigned NOT NULL default '0',
...
DROP TABLE IF EXISTS `gaosou_resume_data`;
CREATE TABLE `gaosou_resume_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
  PRIMARY KEY  (`itemid`)
