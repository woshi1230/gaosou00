DROP TABLE IF EXISTS `gaosou_quote`;
CREATE TABLE `gaosou_quote` (
...
DROP TABLE IF EXISTS `gaosou_quote_data`;
CREATE TABLE `gaosou_quote_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` longtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='行情内容';

DROP TABLE IF EXISTS `gaosou_quote_price`;
CREATE TABLE `gaosou_quote_price` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `gaosou_quote_product`;
CREATE TABLE `gaosou_quote_product` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `catid` int(10) unsigned NOT NULL default '0',
  `areaid` int(10) unsigned NOT NULL default '0',
  `level` tinyint(1) unsigned NOT NULL default '0',
