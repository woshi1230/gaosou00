DROP TABLE IF EXISTS `gaosou_club`;
CREATE TABLE `gaosou_club` (
...
DROP TABLE IF EXISTS `gaosou_club_data`;
CREATE TABLE `gaosou_club_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` longtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='商圈帖子内容';

DROP TABLE IF EXISTS `gaosou_club_fans`;
CREATE TABLE `gaosou_club_fans` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `gid` bigint(20) unsigned NOT NULL default '0',
  `username` varchar(30) NOT NULL default '',
  `passport` varchar(30) NOT NULL,
...
DROP TABLE IF EXISTS `gaosou_club_group`;
CREATE TABLE `gaosou_club_group` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `catid` int(10) unsigned NOT NULL default '0',
  `areaid` int(10) unsigned NOT NULL default '0',
  `level` tinyint(1) unsigned NOT NULL default '0',
...
DROP TABLE IF EXISTS `gaosou_club_manage`;
CREATE TABLE `gaosou_club_manage` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `gid` bigint(20) unsigned NOT NULL default '0',
...
DROP TABLE IF EXISTS `gaosou_club_reply`;
CREATE TABLE `gaosou_club_reply` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `tid` bigint(20) unsigned NOT NULL default '0',
  `gid` bigint(20) unsigned NOT NULL default '0',
