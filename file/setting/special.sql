DROP TABLE IF EXISTS `gaosou_special`;
CREATE TABLE `gaosou_special` (
...
DROP TABLE IF EXISTS `gaosou_special_data`;
CREATE TABLE `gaosou_special_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` longtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='专题内容';

DROP TABLE IF EXISTS `gaosou_special_item`;
CREATE TABLE `gaosou_special_item` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
