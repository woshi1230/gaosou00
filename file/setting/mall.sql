DROP TABLE IF EXISTS `gaosou_mall`;
CREATE TABLE `gaosou_mall` (
...
DROP TABLE IF EXISTS `gaosou_mall_cart`;
CREATE TABLE `gaosou_mall_cart` (
...
DROP TABLE IF EXISTS `gaosou_mall_comment`;
CREATE TABLE `gaosou_mall_comment` (
...
DROP TABLE IF EXISTS `gaosou_mall_data`;
CREATE TABLE `gaosou_mall_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='商城内容';

DROP TABLE IF EXISTS `gaosou_mall_express`;
CREATE TABLE `gaosou_mall_express` (
...
DROP TABLE IF EXISTS `gaosou_mall_order`;
CREATE TABLE `gaosou_mall_order` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `gaosou_mall_stat`;
CREATE TABLE `gaosou_mall_stat` (
  `mallid` bigint(20) unsigned NOT NULL default '0',
  `seller` varchar(30) NOT NULL default '',
