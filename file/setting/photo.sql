DROP TABLE IF EXISTS `gaosou_photo_12`;
CREATE TABLE `gaosou_photo_12` (
...
DROP TABLE IF EXISTS `gaosou_photo_data_12`;
CREATE TABLE `gaosou_photo_data_12` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` longtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='图库内容';

DROP TABLE IF EXISTS `gaosou_photo_item_12`;
CREATE TABLE `gaosou_photo_item_12` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
