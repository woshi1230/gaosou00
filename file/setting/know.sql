DROP TABLE IF EXISTS `gaosou_know`;
CREATE TABLE `gaosou_know` (
...
DROP TABLE IF EXISTS `gaosou_know_answer`;
CREATE TABLE `gaosou_know_answer` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `gaosou_know_data`;
CREATE TABLE `gaosou_know_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` longtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='知道内容';

DROP TABLE IF EXISTS `gaosou_know_expert`;
CREATE TABLE `gaosou_know_expert` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `gaosou_know_vote`;
CREATE TABLE `gaosou_know_vote` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `qid` bigint(20) unsigned NOT NULL default '0',
  `aid` bigint(20) unsigned NOT NULL default '0',
  `username` varchar(30) NOT NULL default '',
