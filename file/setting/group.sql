DROP TABLE IF EXISTS `gaosou_group`;
CREATE TABLE `gaosou_group` (
...
DROP TABLE IF EXISTS `gaosou_group_data`;
CREATE TABLE `gaosou_group_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='团购内容';

DROP TABLE IF EXISTS `gaosou_group_order`;
CREATE TABLE `gaosou_group_order` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
