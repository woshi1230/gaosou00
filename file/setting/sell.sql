DROP TABLE IF EXISTS `gaosou_sell_5`;
CREATE TABLE `gaosou_sell_5` (
...
DROP TABLE IF EXISTS `gaosou_sell_data_5`;
CREATE TABLE `gaosou_sell_data_5` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='供应内容';

DROP TABLE IF EXISTS `gaosou_sell_search_5`;
CREATE TABLE `gaosou_sell_search_5` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
  `catid` int(10) unsigned NOT NULL default '0',
  `areaid` int(10) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
