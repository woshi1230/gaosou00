DROP TABLE IF EXISTS `gaosou_exhibit`;
CREATE TABLE `gaosou_exhibit` (
...
DROP TABLE IF EXISTS `gaosou_exhibit_data`;
CREATE TABLE `gaosou_exhibit_data` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='展会内容';

DROP TABLE IF EXISTS `gaosou_exhibit_order`;
CREATE TABLE `gaosou_exhibit_order` (
  `itemid` bigint(20) unsigned NOT NULL auto_increment,
