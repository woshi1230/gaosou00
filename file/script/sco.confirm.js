...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal" id="' + this.options.target.substr(1) + '"><div class="modal-dialog"><div class="modal-content"><div class="modal-body"><div class="inner"></div></div><div class="modal-footer"><a class="kbtn btn-default cancel" href="#" data-dismiss="modal">取消</a> <a href="#" class="kbtn btn-danger" data-action="1">确定</a></div></div></div>').appendTo(this.options.appendTo).hide();
