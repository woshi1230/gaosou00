...
function LoadSelection()
{
	...
	OnDialogTabChange('Info');//gaosou ADD
...
function UpdateImage( e, skipId )
{
	...
	if(GetE('txtWidth').value > 0) SetAttribute( e, "width" , GetE('txtWidth').value ) ;//gaosou ADD
	if(GetE('txtHeight').value > 0) SetAttribute( e, "height", GetE('txtHeight').value ) ;//gaosou ADD
