...
$moddir = $MODULE[2]['moduledir'].'/editor/';
...
$editor .= 'var EDPath = "'.DT_STATIC.$moddir.'fckeditor/";';
...
$editor .= '</script>';
$editor .= '<script type="text/javascript" src="'.DT_STATIC.$moddir.'fckeditor/fckeditor.js?v=6.0"></script>';
$editor .= '<script type="text/javascript">';
$editor .= 'window.onload = function() {';
$editor .= 'var sBasePath = "'.DT_STATIC.$moddir.'fckeditor/";';
...
$editor .= '}';
$editor .= '</script>';
$editor .= '<script type="text/javascript" src="'.DT_STATIC.$moddir.'fckeditor/init.api.js"></script>';
