...
FCKConfig.ToolbarSets["Default"] = [
	['Source','-','Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','Templates'],
	['Link','Unlink','Anchor'],
	['Image','Table','Rule','Smiley','SpecialChar','-','FitWindow'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','RemoveFormat'],
	['OrderedList','UnorderedList','Outdent','Indent','-','Style','FontFormat']
];
if(!IsAdmin) FCKConfig.ToolbarSets["Default"][0].splice(0,2);

FCKConfig.ToolbarSets["gaosou"] = [
	['Source','-','PasteWord','PasteText','-','Bold','TextColor','FontSize','Link','Unlink','Image','Flash','Rule','SpecialChar','JustifyLeft','JustifyCenter','JustifyRight','RemoveFormat','Attach','FitWindow','-','Templates']
];
if(!IsAdmin) FCKConfig.ToolbarSets["gaosou"][0].splice(0,2);
if(window.parent.ModuleID == 18) FCKConfig.ToolbarSets["gaosou"][0].splice(-1,0,'Smiley');
...
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + '../../../../member/image.php?editor=1';
