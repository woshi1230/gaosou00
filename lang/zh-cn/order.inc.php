...
$L['trade_status'] = array(
	'<span style="color:#008080;display: block;">待确认</span>',
	'<span style="color:#FF6600;display: block;">待付款</span>',
	'<span style="color:#0000FF;display: block;">待发货</span>',
	'<span style="color:#FF0000;display: block;">已发货</span>',
	'<span style="color:#008000;display: block;">交易成功</span>',
	'<span style="color:#FF0000;display: block;text-decoration:underline;">申请退款</span>',
	'<span style="color:#0000FF;display: block;text-decoration:underline;">已退款</span>',
	'<span style="color:#008080;display: block;">货到付款</span>',
	'<span style="color:#888888;display: block;text-decoration:line-through;">买家关闭</span>',
	'<span style="color:#888888;display: block;text-decoration:line-through;">卖家关闭</span>',
);
