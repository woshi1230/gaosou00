...
//类文件的公共
    ...
    'task_over_congra_witkey'=>'任务已圆满结束，恭喜中标高手',
...
/**keke_base_class 中 filter_xss方法**/
    'xss_attack_warning_notice'=>'XSS攻击警告!这个请求地址有安全问题，服务器拒绝响应',  
      ...
      'kppw_install_notice'=>'高手程序，安装提示',
      'you_not_install_kppw_notice'=>'您还没有正常安装高手程序，请安装后再进行操作',
      'day_before'=>'天前',
      'hour_before'=>'小时前',
      'minute_before'=>'分钟前',
      'seconds_before'=>'秒钟前',
...
/**show_msg.htm**/
	...
	'here'=>'这里',
	'system_message' => '系统短信',
	'goods_pay_success'=>'高手作品付款成功',
	'goods_pay_fail'=>'高手作品付款失败',
	'service_pay_success'=>'高手作品付款成功',
	'service_pay_fail'=>'高手作品付款失败',
/*add*/
    //protocol.php
