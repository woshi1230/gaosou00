...
<div style="width:100%;text-align:center;">
	...
	<div style="padding:0 16px;font-size:16px;color:#555555;line-height:32px;">
		<?php
		if($DT_TOUCH) {
			echo $DT_MOB['browser'] == 'weixin' ? '请长按上面的二维码<br/>选择识别图中二维码' : '请使用微信扫描二维码完成支付<br/><a href="http://app.gaosou.com/scan/" rel="external" style="color:#2E7DC6;text-decoration:none;">如何扫描？</a>';
		} else {
