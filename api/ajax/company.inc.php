...
//			echo "<span class=\"level\">新兵</span></a>";
	...
	if($items) {
		...
		echo "	<a href=\"".$MODULE[42][linkurl]."\" ><strong><span style=\"color: #ff8a00;padding-right: 10px;\">高手排行</span> ".$catname."</strong></a>";
		echo "</div>";
...
//		if ($iListWidth==2) $iListWidth = 440; //232*2;
		if ($iListWidth==2) $iListWidth = 232; //232*2;
		if ($iListWidth==3) $iListWidth = 232; //232*4/3
		if ($iListWidth==1 || $iListWidth==4) $iListWidth = 232;

		echo "<div style=\"width: ".$iListWidth."px;float: left;padding-left: 6px;height: 590px;background: url('".DT_SKIN."image/home/list_of_name.png');background-size: ".$iListWidth."px 590px;\">";
