...
$strSql = ' select a.*,b.task_title,c.title from '.TB_PRE.'witkey_finance a left join '
		.TB_PRE.'witkey_task b on a.obj_id=b.task_id left join '.TB_PRE
...
$intCount = intval(db_factory::execute(sprintf($strSql.$strWhere,TB_PRE)));
