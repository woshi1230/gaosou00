...
$twoPassword = keke_user_class::get_password ( $arrMemer['password'], $arrMemer['passsalt'] );
$intUserRole = intval($gUserInfo['user_type']);
$footer_load = 1;
$identy_auth_info = kekezu::get_table_data ( 'auth_code,auth_status', TB_PRE . 'witkey_auth_record', "uid=" . $gUid, '', '', '', 'auth_code' );
if($intUserRole === 2){
