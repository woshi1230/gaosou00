...
<title>管理中心 - <?php echo $DT['sitename']; ?> - Powered By GAOSOU B2B <?php echo $edition;?> V<?php echo DT_VERSION; ?> R<?php echo DT_RELEASE;?> <?php echo DT_CHARSET;?> <?php echo strtoupper(DT_LANG);?></title>
