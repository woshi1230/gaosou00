...
<title>管理员登录 - Powered By GAOSOU B2B <?php echo $edition;?></title>
<meta name="generator" content="GAOSOU B2B,www.gaosou.net"/>
<link rel="stylesheet" href="admin/image/login.css" type="text/css" />
<script type="text/javascript" src="<?php echo DT_STATIC;?>lang/<?php echo DT_LANG;?>/lang.js"></script>
<script type="text/javascript" src="<?php echo DT_STATIC;?>file/script/config.js"></script>
<script type="text/javascript" src="<?php echo DT_STATIC;?>file/script/jquery.min.js"></script>
...
<td>
	<div class="msg">
		...
		<tr>
		<td colspan="2" height="50"><a href="http://www.gaosou.net/" target="_blank"><img src="admin/image/spacer.gif" width="290" height="30" title="Powered By www.gaosou.net" alt=""/></a></td>
		</tr>
		<tr>
	...
	<div style="margin:10px 40px 0 40px;border:#FF8D21 1px solid;background:#FFFFDD;padding:8px;"><img src="admin/image/notice.gif" align="absmiddle"/> 提示：为了系统安全，请立即修改后台文件名 <a href="http://help.gaosou.com/use/34.html" target="_blank" style="color:#006699;">帮助&#187;</a></div>
