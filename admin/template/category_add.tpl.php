...
<!--添加上的传图功能-->
	<tr>
		...
		<td><input name="category[thumb]" type="text" size="60" id="thumb"/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid; ;?>,<?php echo $MOD['thumb_width'];?>,<?php echo $MOD['thumb_width'];?>, Dd('thumb').value);" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('thumb').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('thumb').value='';" class="jt">[删除]</span><br/>
