...
<div class="tt">gaosou系统表[共<?php echo $dtotalsize;?>M,<?php echo count($dtables);?>个表]</div>
...
<input type="submit" value="删除表" class="btn" onclick="if(confirm('警告！确定要删除中表吗？此操作将不可恢复\n\n为了系统安全，系统仅删除非gaosou系统表')){this.form.action='?file=<?php echo $file;?>&action=drop';}else{return false;}"/>
</div>
</form>
<br/>
