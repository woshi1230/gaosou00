...
<td><textarea name="content" id="content" class="dsn"><?php echo $content;?></textarea><?php echo deditor($moduleid, 'content', '', '100%', 350);?><br/><span id="dcontent" class="f_red"></span>
</td>
</tr>
</table>
