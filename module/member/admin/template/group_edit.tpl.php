...
<tr>
<td class="tl">允许上传空间总容量限制</td>
<td><input name="setting[uploadtotalsize]" type="text" value="<?php echo $uploadtotalsize;?>" size="10"/> Mb 不填或填0表示继承网站设置</td>
</tr>
<tr>
