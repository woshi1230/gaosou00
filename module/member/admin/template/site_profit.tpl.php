...
<td class="f_blue"><?php if($v['site_profit'] > 0) echo $v['site_profit'];?></td>
<td class="f_red"><?php if($v['site_profit'] < 0) echo $v['site_profit'];?></td>
<td><?php echo $v['bank'];?></td>
<td class="px11"><?php echo $v['addtime'];?></td>
<td><?php echo $v['editor'];?></td>
<td class="px11 f_gray">
	<?php if($fina_action_arr[$v['reason']]) { ?>
		<?php echo $fina_action_arr[$v['reason']];?>
	<?php } else { ?>
		<?php echo $v['reason'];?>
	<?php } ?>
</td>
<td class="px11 f_gray"><?php echo $v['note'];?></td>
</tr>
<?php }?>
<tr align="center">
<td></td>
