...
<option value="gaosou"<?php if($editor == 'gaosou') echo ' selected';?>>精简</option>
...
<td><input name="setting[passport_url]" type="text" size="50" value="<?php echo $passport_url;?>"/><?php tips('整合程序接口地址 例如:http://bbs.gaosou.com 结尾不要带斜线');?></td>
</tr>
<tr>
<td class="tl">整合密钥</td>
...
<td><input name="setting[uc_api]" type="text" size="50" value="<?php echo $uc_api;?>" id="uc_api"/><?php tips('整合程序接口地址 例如:http://bbs.gaosou.com 结尾不要带斜线');?></td>
</tr>
<tr>
<td class="tl">主机IP</td>
