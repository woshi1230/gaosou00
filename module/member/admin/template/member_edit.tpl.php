...
<span class="f_gray">建议使用标志性图片，最佳大小为<?php echo $MOD['thumb_width'];?>px*<?php echo $MOD['thumb_height'];?>px</span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 主营行业</td>
<td>																	  		  <!-- 此处“42”原为“4”，如此会修改后台“公司列表”和“高手列表”中“编辑会员列表”和“添加会员”页面中“主营行业”分类处。-->
		<div id="catesch"></div><div id="cate"><?php echo ajax_category_select('', '', 0, 42, 'size="2" style="height:80px;width:160px;"');?></div>
...
<td><input type="text" size="30" name="member[domain]" id="domain" value="<?php echo $domain;?>"/><?php tips('例如 www.gaosou.net 不带http<br/>同时需要会员将此域名IP指向本站服务器');?></td>
</tr>
<tr>
