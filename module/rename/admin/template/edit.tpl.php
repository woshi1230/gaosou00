...
<input type="hidden" name="forward" value="<?php echo $catid;?>"/>
...
var property_task_id = <?php echo $task_id;?>;
...
<td><textarea name="post[task_desc]" id="task_desc" class="dsn"><?php echo $task_desc;?></textarea>
<?php echo deditor($moduleid, 'task_desc', $MOD['editor'], '100%', 350);?><br/><span id="dtask_desc" class="f_red"></span>
</td>
</tr>
<tr>
