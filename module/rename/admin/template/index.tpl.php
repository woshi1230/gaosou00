...
ID：<input type="text" size="4" name="task_id" value="<?php echo $task_id;?>"/>&nbsp;
...
<td><input type="checkbox" name="task_id[]" value="<?php echo $v['task_id'];?>"/></td>
...
<td align="left">&nbsp;<a href="<?php echo $v['linkurl'];?>" target="_blank"><?php echo $v['task_title'];?></a><?php if($v['vip']) {?> <img src="<?php echo DT_SKIN;?>image/vip_<?php echo $v['vip'];?>.gif" title="<?php echo VIP;?>:<?php echo $v['vip'];?>" align="absmiddle"/><?php } ?></td>
<td>
<?php if($v['username']) { ?>
...
<?php } ?>
<!--<td class="px11">--><?php //echo $v['view_num'];?><!--</td>-->
<td>
...
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=check&task_id=<?php echo $v['task_id'];?>" onclick=""> <p>审核通过 <p/></a>
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=reject&task_id=<?php echo $v['task_id'];?>" onclick=""> <p>审核失败 <p/></a>
</td>
