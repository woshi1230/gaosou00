...
<form method="post" action="<?php echo DT_PATH;?>module/doc/index.php?" id="dform" onsubmit="return check();">
<input type="hidden" name="moduleid" value="<?php echo $moduleid;?>"/>
<input type="hidden" name="file" value="<?php echo $file;?>"/>
...
<td>
<a href="javascript:pagebreak();Ds('subtitle');"><img src="<?php echo DT_STATIC;?>admin/image/pagebreak.gif" align="absmiddle"/> 插入分页符</a>&nbsp;&nbsp;
