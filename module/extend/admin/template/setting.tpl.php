...
<td><input name="setting[mobile_domain]" type="text" size="30" value="<?php echo $mobile_domain;?>"/><?php tips('例如 http://m.gaosou.com/<br/>请将此域名绑定至网站mobile目录');?></td>
</tr>
<tr> 
...
<td><input name="setting[spread_domain]"  type="text" size="30" value="<?php echo $spread_domain;?>"/><?php tips('例如 http://spread.gaosou.com/<br/>请将此域名绑定至网站spread目录');?></td>
</tr>
<tr> 
...
<td><input name="setting[ad_domain]"  type="text" size="30" value="<?php echo $ad_domain;?>"/><?php tips('例如 http://ad.gaosou.com/<br/>请将此域名绑定至网站ad目录');?></td>
</tr>
<tr>
...
<td><input name="setting[announce_domain]"  type="text" size="30" value="<?php echo $announce_domain;?>"/><?php tips('例如 http://announce.gaosou.com/<br/>请将此域名绑定至网站announce目录');?></td>
</tr>
</table>
...
<td><input name="setting[link_domain]"  type="text" size="30" value="<?php echo $link_domain;?>"/><?php tips('例如 http://link.gaosou.com/<br/>请将此域名绑定至网站link目录');?></td>
</tr>
<tr>
...
<td><input name="setting[comment_domain]"  type="text" size="30" value="<?php echo $comment_domain;?>"/><?php tips('例如 http://comment.gaosou.com/<br/>请将此域名绑定至网站comment目录');?></td>
</tr>
<tr>
...
<td><input name="setting[guestbook_domain]"  type="text" size="30" value="<?php echo $guestbook_domain;?>"/><?php tips('例如 http://guestbook.gaosou.com/<br/>请将此域名绑定至网站guestbook目录');?></td>
</tr>
<tr> 
<td class="tl">留言类型</td>
...
<td><input name="setting[gift_domain]"  type="text" size="30" value="<?php echo $gift_domain;?>"/><?php tips('例如 http://gift.gaosou.com/<br/>请将此域名绑定至网站gift目录');?></td>
</tr>
</table>
...
<td><input name="setting[vote_domain]"  type="text" size="30" value="<?php echo $vote_domain;?>"/><?php tips('例如 http://vote.gaosou.com/<br/>请将此域名绑定至网站vote目录');?></td>
</tr>
</table>
...
<td><input name="setting[poll_domain]"  type="text" size="30" value="<?php echo $poll_domain;?>"/><?php tips('例如 http://poll.gaosou.com/<br/>请将此域名绑定至网站poll目录');?></td>
</tr>
</table>
...
<td><input name="setting[form_domain]"  type="text" size="30" value="<?php echo $form_domain;?>"/><?php tips('例如 http://form.gaosou.com/<br/>请将此域名绑定至网站form目录');?></td>
</tr>
</table>
...
<td><input name="setting[archiver_domain]"  type="text" size="30" value="<?php echo $archiver_domain;?>"/><?php tips('例如 http://archiver.gaosou.com/<br/>请将此域名绑定至网站archiver目录');?></td>
</tr>
</table>
...
<td><input name="setting[feed_domain]"  type="text" size="30" value="<?php echo $feed_domain;?>"/><?php tips('例如 http://feed.gaosou.com/<br/>请将此域名绑定至网站feed目录');?></td>
</tr>
<tr> 
