...
<tr>
<td class="tl"><span class="f_hid">*</span> 广告样式</td>
<td><input type="text" size="50" name="ad[text_style]" value="<?php echo $text_style;?>" id="text_style"/> <span id="dtext_style" class="f_red"></span></td>
</tr>
<tr>
